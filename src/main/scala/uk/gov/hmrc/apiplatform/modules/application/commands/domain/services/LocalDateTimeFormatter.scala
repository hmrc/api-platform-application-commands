...
package uk.gov.hmrc.apiplatform.modules.application.commands.domain.services
...
trait LocalDateTimeFormatter extends EnvReads with EnvWrites {
  ...
  implicit val bobbins: Format[LocalDateTime] = Format(DefaultLocalDateTimeReads, localDateTimeWrites)
}
